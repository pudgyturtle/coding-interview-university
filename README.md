...
- ### Linked Lists
    - [x] Description:
        ...
        - [x] [Linked Lists CS50 Harvard University CONT'D](https://youtu.be/2T-A_GFuoTo?feature=shared&t=3520)
...
- ### Trees - Intro
    ...
    - [x] [BFS(breadth-first search) and DFS(depth-first search) (video)](https://w ww.youtube.com/watch?v=uWL6FJhq5fM)
        - BFS notes:
